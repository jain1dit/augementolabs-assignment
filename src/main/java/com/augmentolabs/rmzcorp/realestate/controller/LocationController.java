...
public class LocationController {
  ...
  public ResponseEntity<Location> getSpecificLocationInSpecificCity(
      @PathVariable long cityId, @PathVariable long locationId) throws Exception {
  ...
  public ResponseEntity<Location> saveNewLocation(
      @PathVariable long cityId, @RequestBody Location location) throws Exception {
  ...
  public ResponseEntity<Location> updateLocation(
      @PathVariable long cityId, @PathVariable long locationId, @RequestBody Location location) {
