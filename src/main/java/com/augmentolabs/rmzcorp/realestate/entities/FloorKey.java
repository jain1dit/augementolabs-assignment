...
// We create this class in order to make two fields a primary key. And for this we also do some
// changes in Floor class.
...
public class FloorKey implements Serializable {
  ...
  //        return getId() == floorKey.getId() && Objects.equals(getBuilding(),
  // floorKey.getBuilding());
  //    }
  //
  //    @Override
  //    public int hashCode() {
